...
sed -i 's/^Depends.*/Depends: ${shlibs:Depends}, ${misc:Depends}, r-3.6.0, libssl-dev, libglu1-mesa-dev, libxml2-dev, libmagick++-dev, libmariadbclient-dev, libpq-dev, libgdal-dev/' debian/control
